...
class ImageNetCervicalPerformance(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "ImageNetCervicalPerformance.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == ImageNetCervicalPerformance.Split.TEST:
            dataset = None
