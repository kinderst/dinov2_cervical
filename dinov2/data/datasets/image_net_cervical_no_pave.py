...
class ImageNetCervicalNoPave(ExtendedVisionDataset):
    ...
    def __init__(
        self,
        *,
        split: "ImageNetCervicalNoPave.Split",
        root: str,
        extra: str,
    ...
    @property
    def split(self) -> "ImageNetCervicalNoPave.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == ImageNetCervicalNoPave.Split.TEST:
            dataset = None
