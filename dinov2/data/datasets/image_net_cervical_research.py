...
class ImageNetCervicalResearch(ExtendedVisionDataset):
    ...
    def __init__(
        self,
        *,
        split: "ImageNetCervicalResearch.Split",
        root: str,
        extra: str,
    ...
    @property
    def split(self) -> "ImageNetCervicalResearch.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == ImageNetCervicalResearch.Split.TEST:
            dataset = None
