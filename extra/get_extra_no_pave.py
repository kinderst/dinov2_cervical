import argparse
from dinov2.data.datasets import ImageNetCervicalNoPave
...
def process_dataset(root, extra):
    ...
    """
    for split in ImageNetCervicalNoPave.Split:
        dataset = ImageNetCervicalNoPave(split=split, root=root, extra=extra)
        dataset.dump_extra()
