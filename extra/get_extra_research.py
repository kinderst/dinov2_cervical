import argparse
from dinov2.data.datasets import ImageNetCervicalResearch
...
def process_dataset(root, extra):
    ...
    """
    for split in ImageNetCervicalResearch.Split:
        dataset = ImageNetCervicalResearch(split=split, root=root, extra=extra)
        dataset.dump_extra()
