import argparse
from dinov2.data.datasets import ImageNetCervicalPerformance
...
def process_dataset(root, extra):
    ...
    """
    for split in ImageNetCervicalPerformance.Split:
        dataset = ImageNetCervicalPerformance(split=split, root=root, extra=extra)
        dataset.dump_extra()
